#' Shift legend to empty facet of facet_wrap()ed ggplot
#' 
#' Found on stackoverflow (https://stackoverflow.com/a/54438496/8117178) and modified to output a ggplot object using the ggplotify package.
#' @author Z.Lin
#' 
