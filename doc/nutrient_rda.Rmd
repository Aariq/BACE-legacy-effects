...
**NOTE** Currently `aug_herbivory` *includes* `jul_herbivory`.
...
`aug_herbivory_mean` is taken directly from the raw data, and I'm not sure how the pot-level means were calculated.
...
oat_rda2 <-
  rda(
    nutr ~ historical * current + aug_herbivory,
    data = oat_nutr,
    scale = TRUE
  )
anova(oat_rda2)
