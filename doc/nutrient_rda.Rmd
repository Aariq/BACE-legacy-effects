...
oat_rda <-
  rda(
    nutr ~ historical * current + jul_herbivory + late_herbivory,
    data = oat_nutr,
    scale = TRUE
  )
```
...
The experimental design (current treatment, historical treatment, their interaction, and herbivory) explain \~234% of variation in nutrients.
The first constrained axis captures \~67% of *that* variance.
