...
longdata_done <- 
  longdata_done %>% 
  mutate(hist_treat = fct_relevel(hist_treat, "high", "medium", "low"), 
         curr_treat = fct_relevel(curr_treat, "ambient", "75%", "50%"))
```
...
```
Harvest was not super reliable because of dehiscence and lost beans and oats. Focus only on chemistry here.
